                ...
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-12 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">
                            Integrate with AI and Medical Tools You Trust
                        </h2>
                        <p className="text-muted-foreground">
                            Connect your transcription dashboard with advanced AI services, healthcare databases, and
                            productivity tools. From Google PaLM to Gemini — automate, analyze, and document your
                            medical conversations with precision.
                        </p>
